...
| --- | --- | --- | --- | --- | --- | --- | --- |
| AWS Kinesis/SQS | inventory, configuration, operational metrics, DLQ relations | CloudWatch and metadata/list APIs; never GetRecords or ReceiveMessage | read-only list/describe/metrics | Team 4 | Team 1 | existing worker runtime | fixture normalization/runtime |
