...
## Execution
stage decrypt-only overlap and bounded re-encryption. Use OCC and do not retry an ambiguous destructive result automatically.
...
## Rollback
retain old decrypt key until usage is zero. Re-verify readiness and append rollback evidence.
