...
## Execution
record bounded review metadata and close. Use OCC and do not retry an ambiguous destructive result automatically.
...
## Rollback
reopen a new reviewed record; terminal state is immutable. Re-verify readiness and append rollback evidence.
