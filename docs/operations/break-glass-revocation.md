...
## Execution
revoke the grant with OCC. Use OCC and do not retry an ambiguous destructive result automatically.
...
## Rollback
confirm authorization denial. Re-verify readiness and append rollback evidence.
