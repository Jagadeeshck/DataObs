...
## Plan and execution
Record metadata without kubeconfig, validate Kubernetes/support/capacity/failure domains, certify, then mark ready. Drain before unregistering active installations.
