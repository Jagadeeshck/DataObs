...
## Execution
promote the retained prior reference and verify. Use OCC and do not retry an ambiguous destructive result automatically.
...
## Rollback
escalate if prior material is unavailable. Re-verify readiness and append rollback evidence.
