...
## Execution
stage reference, verify, promote, then retire. Use OCC and do not retry an ambiguous destructive result automatically.
...
## Rollback
roll back before retirement. Re-verify readiness and append rollback evidence.
