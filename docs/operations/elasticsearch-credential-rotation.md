...
## Execution
stage externally, test least privileges, roll workloads, retire old. Use OCC and do not retry an ambiguous destructive result automatically.
...
## Rollback
restore old reference before retirement. Re-verify readiness and append rollback evidence.
