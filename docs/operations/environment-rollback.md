...
## Plan and execution
Verify previous immutable digests and migration/data compatibility. Roll back application only when compatibility permits; never destructively reverse Elasticsearch.
