...
## Execution
refresh provider JWKS and test new/retired keys. Use OCC and do not retry an ambiguous destructive result automatically.
...
## Rollback
restore provider trust only under identity runbook. Re-verify readiness and append rollback evidence.
