...
## Execution
stage provider-managed client secret reference and roll. Use OCC and do not retry an ambiguous destructive result automatically.
...
## Rollback
restore previous accepted client reference. Re-verify readiness and append rollback evidence.
