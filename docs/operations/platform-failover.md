...
## Plan and execution
Build a manual plan; verify recovery target, backup/restore, release/migration, OIDC, Elasticsearch, secrets, ingress/DNS, telemetry and tenant scope. No automatic DNS in v1.
