...
## Plan and execution
Promote exact SHA and signed digests only after source certification, approved release decision, destination support, backup/security/SLO and migration gates.
