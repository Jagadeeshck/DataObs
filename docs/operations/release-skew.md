...
## Plan and execution
Classify expected/planned/warning/unsupported/security-critical skew. Unknown production digest, terminal migration mismatch or unsupported platform is critical.
