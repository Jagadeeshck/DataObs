...
## Execution
notify owner, suspend or renew metadata with approval. Use OCC and do not retry an ambiguous destructive result automatically.
...
## Rollback
reactivate only through approval. Re-verify readiness and append rollback evidence.
