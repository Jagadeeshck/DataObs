...
## Execution
verify chain, hostname, expiry and usage; roll if no hot reload. Use OCC and do not retry an ambiguous destructive result automatically.
...
## Rollback
restore prior certificate reference. Re-verify readiness and append rollback evidence.
