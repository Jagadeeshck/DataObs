...
_MUTATION = re.compile(
    r"\b(INSERT|UPDATE|DELETE|REPLACE|MERGE|CREATE|ALTER|DROP|TRUNCATE|RENAME|COPY|CALL|DO|LOAD|LOCK\s+TABLES|UNLOCK\s+TABLES|GRANT|REVOKE|INSTALL|UNINSTALL|VACUUM|ANALYZE|OPTIMIZE|REPAIR|REINDEX|FLUSH|RESET|KILL|SET|START\s+TRANSACTION|COMMIT|ROLLBACK|SECURITY\s+LABEL|SESSION\s+AUTHORIZATION)\b",
    re.I,
)
