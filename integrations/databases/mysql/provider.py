...
from .connection import MySqlConnectionFactory
...
class MySqlDatabaseProvider:
    ...
    def __init__(self, connection_factory=None):
        self._factory = connection_factory or MySqlConnectionFactory()
    ...
    def capabilities(self):
        ...
        return ProviderCapabilities(
            ...
            (DRIVER_REQUIREMENT,),
            ("MySQL 8.4 LTS primary; 9.7 compatibility target; query history and raw rows unsupported",),
        )
    ...
    async def validate_configuration(self, context, configuration):
        try:
            ...
            return ValidationResult(
                False, (ValidationIssue("invalid_configuration", "provider", "MySQL configuration is invalid"),)
            )
    ...
    async def test_connection(self, context, configuration):
        try:
            ...
            return ConnectionTestResult(False, error_code=code, message="MySQL connection test failed")
    ...
    async def collect(self, context, request):
        ...
        with self._factory.connect(cfg) as connection:
            ...
            try:
                driver_version = importlib.metadata.version("mysql-connector-python")
            ...
            yield ResourceObservation(
                ...
                source_evidence={
                    ...
                    "driver_name": "mysql-connector-python",
