...
def parse_configuration(raw: Mapping[str, Any]) -> PrestoConfiguration:
    ...
    _keys(metadata, {"include_tables", "include_views", "include_columns"})
    metadata = {k: metadata.get(k, True) for k in ("include_tables", "include_views", "include_columns")}
