...
DATAOBS_INDEX_TEMPLATES: Dict[str, Dict[str, Any]] = {
    "dataobs-assets-v1": {
        "index_patterns": ["dataobs-assets-v1*"],
        "template": {
            "mappings": {
                "properties": {
    ...
    "dataobs-columns-v1": {
        "index_patterns": ["dataobs-columns-v1*"],
        "template": {
            "mappings": {
                "properties": {
    ...
    "dataobs-quality-checks-v1": {
        "index_patterns": ["dataobs-quality-checks-v1*"],
        "template": {
            "mappings": {
                "properties": {
    ...
    "dataobs-quality-runs-v1": {
        "index_patterns": ["dataobs-quality-runs-v1*"],
        "template": {
            "mappings": {
                "properties": {
                    "run_id": {"type": "keyword"},
    ...
    "dataobs-jobs-v1": {
        "index_patterns": ["dataobs-jobs-v1*"],
        "template": {
            "mappings": {
                "properties": {
                    "job_id": {"type": "keyword"},
    ...
    "dataobs-job-runs-v1": {
        "index_patterns": ["dataobs-job-runs-v1*"],
        "template": {
            "mappings": {
                "properties": {
                    "job_run_id": {"type": "keyword"},
                    "job_id": {"type": "keyword"},
                    "job_namespace": {"type": "keyword"},
                    "job_name": TEXT_KW,
                    "job_type": {"type": "keyword"},
                    "source_system": {"type": "keyword"},
                    "status": {"type": "keyword"},
                    ...
                    "started_at": {"type": "date"},
                    "finished_at": {"type": "date"},
                    "nominal_start_time": {"type": "date"},
                    "nominal_end_time": {"type": "date"},
                    "duration_ms": {"type": "long"},
                    "event_count": {"type": "integer"},
                    "input_assets": {"type": "keyword"},
                    "output_assets": {"type": "keyword"},
                    "error_message": TEXT_KW,
                    "logs_url": {"type": "keyword"},
    ...
    "dataobs-lineage-events-v1": {
        "index_patterns": ["dataobs-lineage-events-v1-*"],
        "data_stream": {},
        "template": {
            "mappings": {
                "properties": {
    ...
    "dataobs-lineage-edges-v1": {
        "index_patterns": ["dataobs-lineage-edges-v1*"],
        "template": {
            "mappings": {
                "properties": {
                    "edge_id": {"type": "keyword"},
                    "source_asset_id": {"type": "keyword"},
                    "target_asset_id": {"type": "keyword"},
    ...
    "dataobs-column-lineage-edges-v1": {
        "index_patterns": ["dataobs-column-lineage-edges-v1*"],
        "template": {
            "mappings": {
                "properties": {
                    "edge_id": {"type": "keyword"},
    ...
    "dataobs-incidents-v1": {
        "index_patterns": ["dataobs-incidents-v1*"],
        "template": {
            "mappings": {
                "properties": {
