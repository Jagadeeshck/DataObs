...
export const consoleRoutes: readonly ConsoleRoute[] = [
  ...
  route({
    id: "platform-supportability",
    path: "/administration/platform/supportability",
    name: "Platform Supportability",
    aliases: ["support profile", "diagnostics", "known issues", "maintenance"],
    group: "Configure",
    capabilityId: "platform-operations",
    owner: "team-5",
    workspace: "admin",
    ...
    requiredPermission: "platform_operations:read",
    loader: load(
      "../features/administration/PlatformSupportability",
      "PlatformSupportability",
    ),
  }),
  route({
    id: "platform-readiness",
    path: "/administration/platform/readiness",
    name: "Operational Readiness",
    aliases: ["readiness gates", "readiness blockers", "NO_GO"],
    group: "Configure",
    capabilityId: "platform-operations",
    owner: "team-5",
    workspace: "admin",
