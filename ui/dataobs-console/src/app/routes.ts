...
export const consoleRoutes: readonly ConsoleRoute[] = [
  ...
  route({
    ...
    loader: load("../features/data-contracts/DataContracts", "ContractAuthoring"),
  }),
  route({
  ...
  route({
    ...
    entityParameters: [parameter("contractId", "data-contract"), parameter("version", "contract-version")],
